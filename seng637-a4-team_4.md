...
Then, in the next part of this assignment, we used Selenium IDE to test few different functionalities of the [Amazon](https://www.amazon.ca) website. The selenium IDE recorded test cases are [here](selenium_testing_script.side).
